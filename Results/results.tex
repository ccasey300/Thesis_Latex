...
This sections details the results of daily web connectivity testing using the command \textit{ooniprobe run}. 
...
In this section, the OONI database will be explored. 
...
\midrule
Number of Websites Tested           & XXX & XXX \\
Number of Successful Connections    & XXXX & XX \\
Number of Anomalies                 & XX & XX \\
Number of Failures                  & XX & XX \\
\bottomrule
\end{tabular}
\label{tab:category_block}
\end{table}
